const questions = [
  {
    ...
    function loadQuestion(index) {
      ...
      optionsArray.forEach((option) => {
        ...
        li.innerHTML = `<input type="radio" name="option" value="${option}" onclick="markAttempted(${index}, '${option}')"> ${option}`;
    ...
    function updateNavigation() {
      ...
      questions.forEach((q, index) => {
        let color = "gray"; // Not visited
        if (q.attempted) color = "green"; // Answered
        if (q.selected === "") color = "gray"; // Not answered
        if (index === currentQuestion) color = "blue"; // Current question
